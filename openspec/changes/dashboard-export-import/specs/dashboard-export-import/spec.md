...
## Data Model: ZIP Container Format

All exports produce a ZIP archive named `mydash-export-v1.zip` with the following structure:
...
- `exportedAt` (ISO 8601 UTC string): timestamp of export
- `exportedBy` (string): Nextcloud user ID of the admin who exported
- `mydashVersion` (string): informational; source MyDash version
- `scope` (string): either `"dashboard"` (single) or `"site"` (all)
- `dashboardCount` (integer): count of dashboards in the ZIP
- `includedAssets` (array): always `["icons", "widgetUploads", "metadataFields"]`

### dashboards/<uuid>.json Schema

Each file contains a single Dashboard object with complete state:
  ...
  "widgets": [
    {
      ...
      "height": 4,
      "type": "chart-widget",
      "config": { "chartType": "line", "title": "Revenue Trend" },
      "customTitle": "Monthly Revenue",
      "customIcon": "assets/icons/revenue-icon.png",
      "sortOrder": 0
    }
  ],
  "metadataFields": [
...
## TRANSACTIONAL & PERFORMANCE Requirements
