# Spec delta — widget-add-edit-modal

## ADDED Requirements

### Requirement: REQ-WDG-019 Widget registry completeness verifiable in CI
...
- `label`, `text`, `image`, `link`, `nc-widget`, `tile`, `video` (current set; updated when widget capabilities are added or removed)
...
- **GIVEN** the registry currently contains `label`, `text`, `image`, `link`, `nc-widget`, `tile`, `video`
...
- **GIVEN** EXPECTED_TYPES lists 7 types
