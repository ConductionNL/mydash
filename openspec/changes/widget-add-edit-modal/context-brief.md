# Context Brief: Widget add/edit modal

**App:** MyDash — Dashboard system
**Spec:** widget-add-edit-modal
...
**Lives at:** Dashboards / Canvas modal

**Rationale:** Canvas interaction  
...
### Widget management
**demand: 564** (7 tender mentions) | Category: other

CAPABILITY: As a dashboard user, I want to add, remove, and rearrange widgets on my personal dashboard, so that I see the information most relevant to me. ACCEPTANCE CRITERIA:
1. GIVEN I am on my dashboard, WHEN I open the widget picker and select a widget, THEN it appears on my dashboard and persists across sessions.
2. GIVEN I have multiple widgets on my dashboard, WHEN I drag a widget to a new position, THEN the new layout is saved and restored on next visit.
3. GIVEN a widget is on my dashboard, WHEN I remove it, THEN it disappears immediately and is no longer shown on subsequent visits.

### Add widget from widget catalog
