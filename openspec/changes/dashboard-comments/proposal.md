...
- `dashboard-comments`: introduces REQ-CMNT-001 through REQ-CMNT-009 covering list, create, nesting limit, edit, delete, mentions, per-dashboard toggle, global toggle, and permission integration.
