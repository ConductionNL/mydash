...
# Dashboard UI — Switcher Sidebar Requirements

## Context

The dashboard switcher is a left-edge slide-in sidebar component that renders all dashboards visible to the user, grouped by source (primary group, default group, personal). It provides fast switching, personal-dashboard creation and deletion, active-dashboard highlighting, and persistent brand/documentation footer.
